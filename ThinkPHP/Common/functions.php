...
function think_filter(&$value){
    ...
    /*if(preg_match('/^(EXP|NEQ|GT|EGT|LT|ELT|OR|XOR|LIKE|NOTLIKE|NOT BETWEEN|NOTBETWEEN|BETWEEN|NOTIN|NOT IN|IN|request_url)$/i',$value)){    
        $value .= ' ';
    }*/
    if(preg_match('/^(EXP|NEQ|GT|EGT|LT|ELT|OR|XOR|LIKE|NOTLIKE|NOT BETWEEN|NOTBETWEEN|BETWEEN|NOTIN|NOT IN|IN|select|insert|delete|count|where|and)$/i',$value)){
        $value .= ' ';
    }
