...
<div id="programlist" class="programlistbox pclistnav">
    ...
    <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><div class="positiononly clearfix">
            <!--标题-->
            <!-- <h2 class="pctips state1"><span style="display:none;"><?php echo ($vo["title"]); ?></span></h2> -->
            <h2><span style="display:none;"><?php echo ($vo["title"]); ?></span></h2>
            <!--图片-->
            <div class="clearfix" style="margin-left:120px;width:60%; height:335px;">
                <a href="<?php echo U('Zhongchou/show',array('id'=>$vo['id']));?>">
                    <img style="width: 100%;" src="<?php echo ($vo["pic"]); ?>" alt="<?php echo ($vo["title"]); ?>">
                </a>
            </div>
        </div>
    <!--内容--><?php endforeach; endif; else: echo "" ;endif; ?>
