...
class EntrustController extends TradeFatherController {
	...
	public function manage(){
		...
		$list = M('Orders')
			  ->Field('orders_id,member_id,currency_id,currency_trade_id,price,num,trade_num,fee,type,add_time,trade_time,status')
			  ->where($where)
